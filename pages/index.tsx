  ...
  return (
    <main className="h-screen select-none">
      ...
      <div className="w-screen  flex items-center justify-center h-90per relative">
        {notificationIsOpen || <button onClick={openNotification} className="bg-green-700 rounded-full px-5 py-3 text-white ">1 new notification</button>}


        {notificationIsOpen && <NotificationView closeNotification={setNotification} openDetailView={setDetailView}/>}
        {isDetailView && <DetailView closeDetailView={setDetailView} openReportView={setReportView}/>}
